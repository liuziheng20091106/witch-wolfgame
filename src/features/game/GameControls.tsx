import { BookOpen, CirclePause, CirclePlay, RotateCcw, Settings, StepBack } from 'lucide-react';
...
export function GameControls({ paused, onPaused, onSettings, onReference, onRestart, onExit }: GameControlsProps) {
  return <section className={styles.controls} aria-label="游戏控制">
    ...
    <button type="button" onClick={onReference} title="职业与魔法图鉴" aria-label="职业与魔法图鉴"><BookOpen /></button>
