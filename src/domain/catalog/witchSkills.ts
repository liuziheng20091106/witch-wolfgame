...
export const skillUsageHints: Partial<Record<WitchSkillId, string>> = {
 ...
 brainwash: '使用建议：你的魔法是洗脑。使用后，你当天的洗脑发言会作为强提示词发送给其他玩家。请务必给洗脑内容前后加上【】，内容不得超过 6 个字；若违反以上两条，魔法无效。洗脑内容必须是明确指令或断言（如【投票给1号】【1号是狼人】【说爱我】），不要说【愚蠢】【真是无聊】这类无意义情绪词浪费魔法。本魔法整局限一次，若信息不足可先保留，留到后期信息更充分时使用更有效。',
