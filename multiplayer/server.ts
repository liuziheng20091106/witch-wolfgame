...
const MULTIPLAYER_UPDATE_FILES = [
  ...
  'src/domain/engine/decisions.ts',
  ...
  'src/domain/model.ts',
  'src/domain/skills/clairvoyance.ts',
  'src/domain/skills/creature.ts',
  'src/domain/skills/decisionGuidance.ts',
  'src/domain/skills/ignition.ts',
  'src/domain/skills/lastWords.ts',
  'src/domain/skills/levitation.ts',
