...
八人 AI 狼人杀网页游戏。每局从 14 位角色中选择 8 位，随机分配 2 名狼人、1 名预言家、1 名女巫、1 名猎人和 3 名村民。角色人格、基础职业与魔女技互相独立。

本分支在原项目基础上扩展了八人版型、双轮发言、平票追加发言、猎人开枪、旧六人存档迁移和 AI 规则认知。完整改动见 [CHANGE_README.md](CHANGE_README.md)，面向上游审阅的 PR 说明见 [PR_DESCRIPTION.md](PR_DESCRIPTION.md)。

## 功能

- 全自动 AI 观战，以及用户加入一个席位的参与模式
- 狼人密议与袭击、预言家查验、女巫解药/毒药、猎人死亡开枪
- 每天第一轮固定顺序发言、第二轮确定性随机顺序发言；两人最高票平票时追加发言后重投
- 参与模式中，玩家为存活狼人时固定负责最终夜间袭击，AI 狼人保留密议建议
...
启动命令和原仓库保持一致。IDLE 是 Python 编辑器，不用于启动本项目；请在项目目录的终端中运行以上 npm 命令。
